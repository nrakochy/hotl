...
No leader daemon, no marketplace, no telemetry stack, no enterprise config layers, no RAG (flat memory files first). The harness ships to other owner-operators, not customers.
