...
impl Default for Settings {
    fn default() -> Self {
        Settings {
            ...
            agents: vec!["claude".into(), "codex".into(), "pi".into(), "opencode".into()],
            vim_mode: true,
...
mod tests {
    ...
    fn defaults_when_empty() {
        ...
        assert_eq!(c.settings.agents, vec!["claude".to_string(), "codex".to_string(), "pi".to_string(), "opencode".to_string()]);
